...
const CallToAction = () => {
  return (
    <section className="call-to-action bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-700 text-white p-6 sm:p-8 md:p-12 text-center rounded-lg shadow-lg">
      ...
      <div className="mt-6">
        <button className="px-6 sm:px-8 py-2 sm:py-3 bg-white text-blue-600 font-bold rounded-lg shadow-md hover:bg-blue-600 hover:text-white transition-all duration-300 ease-in-out">
          Get Started
        </button>
      </div>
    </section>
