...
const AdminAssignment = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="relative max-w-lg w-full p-6 bg-white shadow-md rounded-md">
      {/* Back Navigation */}
<div className="absolute top-4 left-4 text-blue-500 hover:text-blue-700 transition duration-300">
  <Backfunction />
</div>
