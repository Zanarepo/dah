    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-5xl bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-md shadow-md hover:shadow-lg transition">
          ...
          <div  className="bg-green-50 border-l-4 border-green-400 p-4 rounded-md shadow-md hover:shadow-lg transition">
          ...
          <div to="" className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-md shadow-md hover:shadow-lg transition">
          ...
          <div to="" className="bg-purple-50 border-l-4 border-purple-400 p-4 rounded-md shadow-md hover:shadow-lg transition">
          ...
          <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded-md shadow-md hover:shadow-lg transition">
            <h2 className="text-xl font-semibold text-red-600 mb-2">Add Department Dashboard</h2>
            <p className="text-gray-600">Add new Dapartment to expand and manage workforce distribution.</p>
          </div>
          ...
          <div className="bg-gray-50 border-l-4 border-gray-400 p-4 rounded-md shadow-md">
            ...
            <p className="text-gray-600">View all notifications related to teams and employees across Dapartment.</p>
          </div>
