  ...
  const RoleAssignment = () => {
    ...
    const updateEmployeeProfile = async (employeeId, roleName) => {
      ...
      if (error) {
        ...
        setFeedbackMessage("Error updating employee profile.");
      } else {
    ...
    const assignRoleToEmployee = async (employeeId, roleName, ministryId, departmentId) => {
      ...
      if (accessId === null) {
        setFeedbackMessage("Invalid role selected.");
        return;
      }
      ...
      try {
        ...
        if (employeeError || !employeeData) {
          setFeedbackMessage("Selected employee not found.");
          return;
        }
        ...
        if (ministryError || !ministryData) {
          setFeedbackMessage("Selected ministry not found.");
          return;
        }
        ...
        if (departmentError || !departmentData) {
          setFeedbackMessage("Selected department not found.");
          return;
        }
        ...
        setFeedbackMessage("Role assigned successfully!");
        ...
        setFeedbackMessage("Error assigning role.");
      }
    };

    const handleRoleAssignment = () => {
      if (!selectedEmployee || !selectedRole || !selectedMinistry || !selectedDepartment) {
        setFeedbackMessage("Please select all fields.");
        return;
      }
