      ...
      <div className="w-full max-w-4xl bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-green-50 border-l-4 border-green-400 p-4 rounded-md">
            <h2 className="text-xl font-semibold text-green-600 mb-2">Manage Departments and Ministries</h2>
            <p className="text-gray-600">
        ...
        <div className="mt-8 text-center">
          <Link to="/explore" className="inline-block bg-blue-600 text-white py-2 px-6 rounded-md shadow-md hover:bg-blue-700 transition">
