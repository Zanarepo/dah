...
import AddDepartment from "../admin/AddDepartment"; // Ensure AddDepartment is imported
import RemoveDepartment from "../admin/RemoveDepartment"; // Ensure RemoveDepartment is imported
